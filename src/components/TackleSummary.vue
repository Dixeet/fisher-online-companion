<template>
  <div class="a-tackle bg-surface px-2 elevation-4 pb-2">
    <div class="text-align--center pa-1 d-flex align-center justify-space-betweene">
      ...
      <div class="flex-grow-1">{{ tackle.name }}</div>
      <div>
    ...
    <TackleSummaryElement v-if="tackle.rod?.id" :equipment="tackle.rod" :par-resolver="pars.rod">
      <i-game-fishing-pole></i-game-fishing-pole>
    </TackleSummaryElement>
    <TackleSummaryElement v-if="tackle.reel?.id" :equipment="tackle.reel" :par-resolver="pars.reel">
      <i-game-film-spool></i-game-film-spool>
    </TackleSummaryElement>
    <TackleSummaryElement v-if="tackle.line?.id" :equipment="tackle.line" :par-resolver="pars.line">
    ...
    >
      <i-game-ice-pop style="transform: rotate(180deg)"></i-game-ice-pop>
    </TackleSummaryElement>
    <TackleSummaryElement
    ...
    <TackleSummaryElement v-if="tackle.feeder?.id && !short" :equipment="tackle.feeder">
      <i-game-full-wood-bucket></i-game-full-wood-bucket>
    </TackleSummaryElement>
    <TackleSummaryElement v-if="tackle.hook?.id || short" :equipment="tackle.hook">
      <i-game-fishing-hook></i-game-fishing-hook>
    </TackleSummaryElement>
    <TackleSummaryElement v-if="tackle.bait?.id && !short" :equipment="tackle.bait">
      <i-game-earth-worm></i-game-earth-worm>
    </TackleSummaryElement>
    <TackleSummaryElement v-if="tackle.lure?.id && !short" :equipment="tackle.lure">
